...
BOT_NAME: process.env.BOT_NAME || "kim_clothing",
...
// make true if you want auto reply on status 
        ...
        AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY kim*",
// set the auto reply massage on status reply  


       WELCOME: process.env.WELCOMESTAT"false",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "255764439260",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "ᴍᴀʟᴠɪɴ ᴛᴇᴄʜ",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*©kim_clothing*",
// add bot owner name    
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "255764439260",
